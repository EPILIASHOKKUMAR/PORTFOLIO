          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-slate-700">
              ...
              <p className="text-gray-300 leading-relaxed">
                Computer Science Undergraduate with practical experience in full-stack development through professional internships and independent
projects. Skilled in both Angular and React ecosystems, supported by robust Node.js and Express.js backends. Proficient in designing
RESTful APIs, managing databases, and navigating the full SDLC from initial architecture to Cloud deployment.
              </p>
            </div>
