...
import { Code, LayoutTemplate, Layers, Smartphone } from 'lucide-react';
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'End-to-end web application development with expertise in both frontend and backend technologies including Node.js, Express.js, MongoDB, and RESTful APIs.',
      icon: <Layers className="h-10 w-10 text-purple-400" />,
    },
    {
      title: 'App Development',
      description: 'Developing scalable and feature-rich applications with modern frameworks, integrating AI capabilities, real-time features, and cloud services.',
