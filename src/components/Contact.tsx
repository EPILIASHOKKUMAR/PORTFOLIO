...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Using Web3Forms - Free service that sends emails directly to your inbox
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: '50f061a4-6b3d-4f5d-bf9b-0d8d221ac34d', // Your Web3Forms access key
          name: formData.name,
          email: formData.email,
          subject: formData.subject || 'Portfolio Contact Form',
          message: formData.message,
          from_name: formData.name,
          to_email: 'eppiliashokkumara@gmail.com'
        })
      });
      ...
      setStatus({ 
        type: 'error', 
        message: 'Failed to send message. Please try emailing me directly at eppiliashokkumara@gmail.com' 
      });
    } finally {
      setIsSending(false);
    }
